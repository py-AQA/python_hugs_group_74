...
for i in range(1, 4):
    url = f'https://dzen.ru/news?issue_tld=ru&utm_referrer=dzen.ru'
    # url = f'https://dzen.ru/news?issue_tld=ru'
    # url = f'https://dzen.ru/news/api/v4?issue_tld=ru'
    ...
    all_block_articles = soup.find_all('h2', class_='mg-card__title')
